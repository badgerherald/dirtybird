...
<script>
  ...
  ga('create', 'UA-2337436-4', 'rnadison.com');
  ga('send', 'pageview');
...
<div class="dirty-logo">
<msdarquee direction="right">
<a href="index.php"><img src="logo-main.png" width="400px"/></a>, or whatever
</msdarquee>
</div>
<div class="weather">
<img src="polar-vortex.jpg">
</div>
<div class="weather" style="padding-top: 30px">
<img src="sponsored.png">
</div>
</div>
<nav role="main" class="cf">

	<ul class="cf">
		<li><a href="http://badgerherald.com/" style="font-family:'PT Sans Narrow';text-decoration:none;font-weight:bold;"> &larr; Back to Badgerherald.com</a></li>
		<li><a href="http://badgerherald.com/news">News</a></li>
		<li><a href="http://badgerherald.com/oped">Opinion</a></li>
		<li><a href="http://badgerherald.com/artsetc">ArtsEtc</a></li>
		<li><a href="http://badgerherald.com/sports">Sports</a></li>
		<li><a href="http://badgerherald.com/shoutouts">Shoutouts</a></li>
		<li id="date" style="float:right; padding-right: 20px;">April 1st, 2014</li>
	</ul>
